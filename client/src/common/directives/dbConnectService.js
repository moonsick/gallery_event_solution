...
// 안내글 등록 삭제 버튼 noticeDeletgo
        executeResults.noticeDeletgo = function (event_id,notice_id) {
            var deferred = $q.defer();
            $http({
                    method: 'post',
                    url: '/noticeDeletgo',
                    data: {event_id : event_id , notice_id: notice_id}
                }
            ).success(function (data) {
                    deferred.resolve(data.sending);
                }
...
//주변 안내 등록 list tourisme_info_D
        executeResults.tourisme_info_D = function (event_id) {
            var deferred = $q.defer();
            $http({
                    method: 'post',
                    url: '/tourisme_info_D',
...
// 인사말, 초대글, 일정표  정보 가져 오기 event_info_D
        executeResults.event_info_D = function (event_id) {
            var deferred = $q.defer();
            $http({
                    method: 'post',
                    url: '/event_info_D',
...
// 강의 자료 list  lectureMaterialList
        executeResults.lectureMaterialList = function (event_id) {
            var deferred = $q.defer();
            $http({
                    method: 'post',
                    url: '/lectureMaterialList',
                    data: {event_id : event_id}
                }
            ).success(function (data) {
                    deferred.resolve(data.sending);
