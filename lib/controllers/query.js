...
// 행사 신규 등록 하면서 강의 자료 등록
exports.lecture_material_insert="insert into event_info_D select (select count(event_M.event_ID) from event_M),null,null,null";
...
// 강연자 이름만 출력
exports.teacher_name_list="select * from user_D where event_ID=? and user_class_ID=1 and isnull(is_del)";



// 저장 누를시 일정 추가 등록 eventScheduleInsert
exports.eventScheduleInsert="insert into event_schedule_D select ?,1,?,(select count(schedule_ID)+1 from event_schedule_D where event_ID=?),?,?,?,null";



// 수정 버튼 누를시 일정 등록 수정 eventScheduleMod
exports.eventScheduleMod="update event_schedule_D set schedule_seq=? , lecture=? where event_ID=? and user_class_ID=1 and user_ID=? and schedule_ID=?";



// 삭제 버튼 누를시 일정 등록 수정 eventScheduleDelete
exports.eventScheduleDelete="update event_schedule_D set is_del=1 where event_ID=? and user_class_ID=1 and user_ID=? and schedule_ID=?";



// 안내글 list noticeList
exports.noticeList="select * from notice_D where event_ID=? and isnull(is_del) order by notice_ID"
...
exports.noticeDeletgo="update notice_D set is_del=1 where event_ID=? and notice_ID=?"



//주변 안내 등록 list tourisme_info_D
exports.tourisme_info_D="select * from tourisme_info_D where event_ID=? and isnull(is_del)";
...
// 인사말, 초대글, 일정표  정보 가져 오기 event_info_D
exports.event_info_D="select * from event_info_D where event_ID=?"



//인사말 등록
exports.infoLetterInsert="update event_info_D set info_letter_file=? where event_ID=?";
//초대글 등록
exports.welcomeLetterInsert="update event_info_D set welcome_letter_file=? where event_ID=?";
//일정표 등록
exports.agendaLetterInsert="update event_info_D set agenda_file=? where event_ID=?";
// 강의자료 추가 입력 lectureInsert
exports.lectureInsert="insert into lecture_material select ?,(select count(lecture_ID)+1 from lecture_material where event_ID=?),?,?,null";
exports.tourismeInsert="insert into tourisme_info_D select ?,(select count(info_ID)+1 from tourisme_info_D where event_ID=?),?,?,?,null";
...
exports.lectureMaterialList="select * from lecture_material where event_ID=? and isnull(is_del)";
