...
// 인사말 등록
    app.post('/infoLetterInsert',multipartMiddleware, execute.infoLetterInsert);
// 초대글 등록
    app.post('/welcomeLetterInsert',multipartMiddleware, execute.welcomeLetterInsert);
// 일정표 등록
    app.post('/agendaLetterInsert',multipartMiddleware, execute.agendaLetterInsert);
// 강의자료 추가 입력 lectureInsert
    app.post('/lectureInsert',multipartMiddleware, execute.lectureInsert);
//주변안내 등록 tourismeInsertGo
    app.post('/tourismeInsert',multipartMiddleware, execute.tourismeInsert);
...
// 강의 자료 list  lectureMaterialList
    app.route('/lectureMaterialList')
        .post(execute.lectureMaterialList);
...
//주변 안내 등록 list tourisme_info_D
    app.route('/tourisme_info_D')
        .post(execute.tourisme_info_D);
...
// 인사말, 초대글, 일정표  정보 가져 오기 tourisme_info_D
    app.route('/event_info_D')
        .post(execute.event_info_D);
